...
export function getItemFieldByIdPowerShellTool(server: McpServer, config: Config) {
    server.registerTool(
        "common-get-item-field-by-id",
        {
            description: "Gets item fields as either names or fields or template fields by its ID.",
            inputSchema: {
                id: z.string()
                    .describe("The ID of the item to retrieve field information for."),
